...
class SingleMowerSimulationTest {
    ...
    @Test
    void single_mower_simulation_with_only_possible_movements() {
        //Given
    ...
    @Test
    void single_mower_simulation_with_avoiding_out_of_lawn_movements() {
        //Given
        Mower mower = Mower.create(
                MowerId.create(0),
                PositionWithOrientationFactory.createPositionWithNorthOrientation(2, 2),
                NavigationPlan.create(MowerMovement.LEFT_TURN, MowerMovement.FORWARD, MowerMovement.FORWARD, MowerMovement.FORWARD, MowerMovement.LEFT_TURN));
        ...
        //Then
        Map<MowerId, PositionWithOrientation> expectedMowersFinalPositionAdnOrientation = new HashMap<>();
        expectedMowersFinalPositionAdnOrientation.put(MowerId.create(0), PositionWithOrientationFactory.createPositionWithSouthOrientation(0, 2));
